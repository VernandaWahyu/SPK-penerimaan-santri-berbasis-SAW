...
<div class="super_container">
	...
	<div class="home">		
		<div class="section_background" data-parallax="scroll" data-image-src="images/courses_background.jpg" data-speed="0.8"></div>
	</div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title"> SISTEM PENDUKUNG KEPUTUSAN
						UNTUK MENENTUKAN SANTRI PENGHUNI ASRAMA
						PUTRI</h2>
						<div class="section_subtitle"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel gravida arcu. Vestibulum feugiat, sapien ultrices fermentum congue, quam velit venenatis sem</p></div>
					</div>
				</div>
			</div>
			<h2 class="section_title" style="text-align: center;">FASILITAS</h2>
