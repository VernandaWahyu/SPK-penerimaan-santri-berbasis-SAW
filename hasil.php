...
<div class="super_container">
	...
	<div class="features">
		<div class="container">
			...
			<center><h2>Hasil Seleksi Yang Masuk Asrama Putri</h2></center>
				...
				<!-- Features Item -->
                    ...
                    <table class="table table-responsive-sm table-striped" style="margin-top: 20px">
                      ...
                      <tbody>
						<?php 
						$rank = 0;
						$tampilsantri = mysqli_query($mysqli, "SELECT p.*, q.Kuota FROM santri p JOIN kuota q ORDER BY p.Nilai_Akhir DESC");
						while($santri = mysqli_fetch_array($tampilsantri))
						{
							$rank = $rank + 1;
							// Assuming Id_kuota is a single value (not an array), check if the current rank is within the quota
							if ($rank <= $santri['Kuota']) {
						?>
						<tr>
							<td><?php echo $rank; ?></td>
